...
function TaskAssignment({ user }) {
  ...
  // ข้อมูลหน้าที่
  const duties = [
    { value: 'registration', label: 'ลงทะเบียน', color: '#e8f5e8' },
    { value: 'bed_booking', label: 'จองเตียง', color: '#e8f5e8' },
    { value: 'registration_bed', label: 'ลงทะเบียน / จองเตียง', color: '#e8f5e8' },
    { value: 'pipeline', label: 'Pipe line', color: '#e8f5e8' },
    { value: 'emergency_vehicle', label: 'รถ Emergency', color: '#e8f5e8' },
    { value: 'pipeline_emergency', label: 'Pipe line / รถ Emergency', color: '#e8f5e8' },
    { value: 'medicine', label: 'ยา Stock', color: '#e8f5e8' },
    { value: 'productivity', label: 'Productivity', color: '#e8f5e8' },
    { value: 'check_delfib', label: 'Check Delfib', color: '#e8f5e8' },
    { value: 'productivity_check', label: 'Productivity / Check Delfib', color: '#e8f5e8' }
  ];
                                   ...
                                   <select
                                     ...
                                     onChange={(e) => {
                                       ...
                                       if (selectedTeam === 'team_a') {
                                         // TEAM A = เคลื่อนย้ายกู้ชีพ
                                         updateSimpleTaskData(shift.id, staff.id, 'assistantErt', 'life_support', true);
                                       } else if (selectedTeam === 'team_b') {
                                         // TEAM B = ช่างและเส้นทาง
                                         updateSimpleTaskData(shift.id, staff.id, 'assistantErt', 'technician', true);
                                       }
                                     }}
                                     className="task-select"
                                     style={{
