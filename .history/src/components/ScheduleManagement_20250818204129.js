  ...
  const restoreMissingStaffComplete = async () => {
    try {
      ...
      const missingStaff = {
        ...
        department: user?.department || 'หอผู้ป่วยศัลยกรรมอุบัติเหตุ',
        order: 17,
      ...
      setStaffList(prev => [...prev, newStaff].sort((a, b) => (a.order || 0) - (b.order || 0)));
        ...
        <div className="schedule-controls">
          ...
          <div className="recovery-section" style={{ 
            ...
            <h4 style={{ 
              ...
              ⚠️ กู้คืนข้อมูลเจ้าหน้าที่ที่หายไป
            </h4>
            <p style={{ 
              margin: '0 0 10px 0', 
              color: '#856404', 
              ...
              นางสาวสุกัญญา วุฒิเดช (ผู้ช่วยพยาบาล ลำดับที่ 17)
            </p>
            <p style={{ 
              margin: '0 0 12px 0', 
              color: '#856404', 
              ...
              🔄 แบบสมบูรณ์: กู้คืนทั้งข้อมูลเจ้าหน้าที่และตารางเวรเก่า
            </p>
            <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
              <button 
                onClick={checkDataIntegrityDetailed} 
                className="btn btn-warning" 
              ...
              <button 
                onClick={restoreMissingStaffComplete} 
                className="btn btn-danger" 
                style={{ fontSize: '12px', padding: '6px 12px' }}
              >
                ⚠️ กู้คืนแบบสมบูรณ์
