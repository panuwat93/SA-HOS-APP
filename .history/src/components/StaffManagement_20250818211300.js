                    ...
                    {currentData.map((staff, index) => (
                      <tr key={staff.id} style={{ 
                        ...
                        <td style={{ padding: '8px', border: '1px solid #dee2e6', fontFamily: 'monospace' }}>
                          {staff.userExists ? staff.username : generateCredentials(staff.firstName, staff.lastName).username}
                        </td>
                        <td style={{ padding: '8px', border: '1px solid #dee2e6', fontFamily: 'monospace' }}>
                          {staff.userExists ? '***' : generateCredentials(staff.firstName, staff.lastName).password}
                        </td>
                        <td style={{ padding: '8px', border: '1px solid #dee2e6' }}>
