...
function StaffCalendar({ user }) {
  ...
  const generateCalendarDays = () => {
    ...
    console.log(`📅 Calendar start date: ${startDate.toDateString()}`);
    ...
    console.log(`📅 First calendar day: ${days[0].toDateString()}`);
    console.log(`📅 Last calendar day: ${days[days.length - 1].toDateString()}`);
