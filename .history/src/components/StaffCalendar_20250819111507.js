            ...
            {todayTasks.map((task, index) => (
              <div key={index} className="task-item">
                <div className="task-title">
                  {task.role || 'งานทั่วไป'} - {task.type || 'งานทั่วไป'} - {task.bedId || 'ไม่ระบุเตียง'}
                </div>
                <div className="task-details">
                  {task.bedId && task.bedId !== 'ไม่ระบุเตียง' && <span className="task-bed">เตียง: {task.bedId}</span>}
                  ...
                  {task.drugControl && <span className="task-drug">ดูแลยาเสพติด: ✓</span>}
                </div>
              </div>
            ))}
          </div>
