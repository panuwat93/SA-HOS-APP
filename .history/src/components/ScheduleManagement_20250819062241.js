      ...
      <div className="schedule-tables">
        ...
        <div className="schedule-section">
          <div className="formatting-toolbar">
            ...
            <div className="toolbar-section">
              <span className="toolbar-label">ตัวอักษรพร้อมสี:</span>
              <button
                onClick={() => user?.canEditSchedule ? applyTextFormat('text', 'ช', '#000000') : null}
                className="format-btn text-btn black"
                title="ช สีดำ"
                disabled={!user?.canEditSchedule}
              >
                ⚫ ช
              ...
              <button
                onClick={() => user?.canEditSchedule ? applyTextFormat('text', 'ช', '#FF0000') : null}
                className="format-btn text-btn red"
                title="ช สีแดง"
                disabled={!user?.canEditSchedule}
              >
                🔴 ช
              ...
              <button
                onClick={() => user?.canEditSchedule ? applyTextFormat('text', 'ด', '#000000') : null}
                className="format-btn text-btn black"
                title="ด สีดำ"
                disabled={!user?.canEditSchedule}
              >
              ...
              <button
                onClick={() => user?.canEditSchedule ? applyTextFormat('text', 'ด', '#FF0000') : null}
                className="format-btn text-btn red"
                title="ด สีแดง"
                disabled={!user?.canEditSchedule}
              >
              ...
              <button
                onClick={() => user?.canEditSchedule ? applyTextFormat('text', 'บ', '#000000') : null}
                className="format-btn text-btn black"
                title="บ สีดำ"
                disabled={!user?.canEditSchedule}
              >
              ...
              <button
                onClick={() => user?.canEditSchedule ? applyTextFormat('text', 'บ', '#FF0000') : null}
                className="format-btn text-btn red"
                title="บ สีแดง"
                disabled={!user?.canSchedule}
              >
                🔴 บ
              </button>
            </div>
